...
<!-- メインビジュアル -->
                <div class="p-main-visual--single">
                    <h1 class="p-main-visual__title c-title--main-visual-single">h1 チーズバーガー</h1>
                </div>
                        ...
                        <figcaption class="p-single-fig__caption">
                            <figure class="p-single-fig__child">
                                <div class="p-single-fig__img-child u-mgr10">
                                    <img src="<?php echo get_theme_file_uri( '/img/single-photos.jpg' ); ?>" alt="">
                                </div>
...
<!-- 画像一覧 -->
                    <ul class="p-photos">
                        <li class="p-photos__top"><img src="<?php echo get_theme_file_uri( '/img/single-photos.jpg' ); ?>" alt="">
                            <ul class="p-photos__ul">
                                <li class="p-photos__list"><img src="<?php echo get_theme_file_uri( '/img/single-photos.jpg' ); ?>" alt=""></li>
                                <li class="p-photos__list"><img src="<?php echo get_theme_file_uri( '/img/single-photos.jpg' ); ?>" alt=""></li>
                                <li class="p-photos__list"><img src="<?php echo get_theme_file_uri( '/img/single-photos.jpg' ); ?>" alt=""></li>
                                <li class="p-photos__list"><img src="<?php echo get_theme_file_uri( '/img/single-photos.jpg' ); ?>" alt=""></li>
                                <li class="p-photos__list"><img src="<?php echo get_theme_file_uri( '/img/single-photos.jpg' ); ?>" alt=""></li>
